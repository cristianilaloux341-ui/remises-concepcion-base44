  ...
  return (
    <>
        {alerts.map((alert) => {
          ...
          const isDateValid = alert.scheduled_datetime && !isNaN(new Date(alert.scheduled_datetime).getTime());
          const hora = isDateValid ? format(new Date(alert.scheduled_datetime), "HH:mm", { locale: es }) : "--:--";
          return (
