            ...
            >
              <Popup>
                <div className="text-sm space-y-1 min-w-[140px]">
                  ...
                  {effectiveBase && <p className="text-gray-500 text-xs">📍 {effectiveBase}</p>}
                  {!driver.current_lat && effectiveBase && <p className="text-gray-400 text-xs">📌 Posición aproximada (base)</p>}
                </div>
              </Popup>
            </Marker>
          );
