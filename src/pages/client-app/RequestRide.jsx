...
export default function RequestRide() {
  ...
  return (
    <div className="h-[100dvh] bg-white flex flex-col">
      ...
      <div className="p-6 bg-white border-b border-slate-100 relative shadow-sm z-10">
        <div className="absolute left-9 top-12 bottom-12 w-[3px] bg-slate-200 rounded-full"></div>
        <div className="space-y-4 relative z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <input type="text" placeholder="¿Hacia dónde vas?" autoFocus className="w-full bg-white p-4 rounded-2xl text-slate-900 font-semibold shadow-[0_0_0_2px_rgba(37,99,235,0.2)] border-blue-500 outline-none" />
          </div>
        </div>
      </div>

      <div className="flex-1 overflow-y-auto p-2">
        <div className="p-4 flex items-center gap-4 active:bg-slate-50 rounded-3xl cursor-pointer transition-colors" onClick={() => navigate('/client/fare')}>
